...
const Orders = ({activeSection}) => {
    ...
    return (
      <>
        {!orders.length ? (
          <div className="flex flex-col items-center justify-center min-h-[50vh] text-center bg-gradient-to-b from-gray-200 to-gray-50 dark:from-zinc-950 dark:to-zinc-900 p-6 rounded-lg animate-slideIn">
            <svg
